                                        ...
                                        Container(
                                          ...
                                          child: ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              ...
                                              return InkWell(
                                                onTap: () {
                                                 GoRouter.of(context).go('/comicsDetail/${item.id}');
                                                },
                                                child: SizedBox(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: ListView.builder(
                                            scrollDirection: Axis.horizontal,
                                            itemCount: state.searchCharacterResults.length,
                                            itemBuilder: (context, index) {
                                              final itemC = state.searchCharacterResults[index];
                                              return InkWell(
                                                onTap: () {
                                                  GoRouter.of(context).go('/character/${itemC.id}');
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ClipRRect(
                                                          borderRadius: const BorderRadius.vertical(top: Radius.circular(10)),
                                                          child: Image.network(
                                                            itemC.image?.iconUrl ?? 'URL par défaut',
                                                            width: double.infinity,
                                                            height: MediaQuery.of(context).size.height * 0.22,
                                                            fit: BoxFit.cover,
                                                            alignment: Alignment.topCenter,
